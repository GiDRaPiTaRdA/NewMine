...
public class BlockInteraction : MonoBehaviour
{
    ...
    private Camera Camera => this.cam.GetComponent<Camera>();
    ...
    private void RaycastInputs()
    {
        ...
        addBlock = InputManager.AddBlock();
        removeBlock = InputManager.RemoveBlock();
        shareBlock = InputManager.ShareBlock();
#elif MOBILE_INPUT
        ...
        if (addBlock || removeBlock || shareBlock)
        {
            ...
            if (Physics.Raycast(this.Camera.ViewportPointToRay(new Vector3(0.5f, 0.5f, 0f)), out RaycastHit hit, 10))
            {
